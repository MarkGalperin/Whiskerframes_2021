...
% DATA_i = load('../data/processed/filtered/filt_janelia_16_(3_25_17).mat');
...
%search parameters
C.res = [0.05, 0.05, 0.005]; %search resolution for r1,r2,th
C.lb = [-3,-0.25,-pi/3]; %lower value bounds
